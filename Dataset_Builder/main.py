...
from Dataset_Builder.merger import merge_all_levels
...
clean_path_h1 = r"C:\AI Stuff\AidCompanion-NLU\Dataset_Builder\Cleaned\ES"
...
merge_all_levels(clean_path_h1,merged_path)
